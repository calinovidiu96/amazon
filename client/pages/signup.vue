                        ...
                        <div class="a-box a-spacing-extra-large">
                            <div class="a-box-inner">
                                ...
                                <div class="a-row a-spacing-base">
                                    ...
                                    <input v-model="email" type="email" id="ap_customer_email" class="a-input-text form-control auth-autofocus auth-required-field auth-contact-verification-request-info">
                                </div>
                                <!-- Your password -->
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label">Your password</label>
                                    <input v-model="password" type="password" id="ap_customer_password" class="a-input-text form-control auth-autofocus auth-required-field auth-contact-verification-request-info">
