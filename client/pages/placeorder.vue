                ...
                <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                  <div class="a-spacing-base">
                    <div class="a-spacing-mini">
                      <span>
                        <strong>Gift cards <span>&nbsp;</span> promotional codes</strong>
                      </span>
                    </div>
                    <div class="row">
                    ...
                    <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id ">
                      <div class="row">
                        ...
                        <div class="col-sm-9 col-9">
                          ...
                          >Sold by:<span>&nbsp;</span>Amazon.com Services, Inc</div>
                          <div class="a-row">
                    ...
                    <div class="a-row shipping-speeds">
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          <!-- Shipping normal -->
                          <input type="radio" name="order0" checked="checked" @click="onChooseShipping('normal')" />
                          <span class="a-radio-label">
                            ...
                            >$13.98<span>&nbsp;</span>-<span>&nbsp;</span>Standard International Shipping - No Tracking</span>
                          </span>
                        </div>
                        <br />
                        <div class="a-spacing-mini tuesday">
                          <!-- Shipping fast -->
                          <input type="radio" name="order0" @click="onChooseShipping('fast')" />
                          <span class="a-radio-label">
                            <span class="a-color-success">
                              <strong>Averages 3 business days</strong>
                            </span>
                            <br />
                            <span class="a-color-secondary">$49.98<span>&nbsp;</span>-<span>&nbsp;</span>Shipping</span>
                          </span>
                        </div>
                      </fieldset>
                    </div>
                  ...
                  <div id="tfx-header">
                    <div class="a-box a-alert-info a-spacing-small">
                      <div class="a-box-inner alert-info-no-icon">
                        <strong>
                          Amazon Currency Converter is Enabled. <span>&nbsp;</span>
                          <a
                            href="#"
                            class="a-size-mini"
                          >Learn More</a>
