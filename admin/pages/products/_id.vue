                ...
                <div class="col-sm-6">
                    <div class="a-section">
                        ...
                        <!-- Owner Dropdown -->
                         <form action="">
                            <div class="a-spacing-top-medium">
                                <label style="margin-bottom: 0px;" for="">Owner</label>
                            ...
                            <input type="text" class="a-input-text" style="width:100%; margin-bottom: 0px;" name="" id="" v-model="title" :placeholder="product.title">
                        </div>

                        <div class="a-spacing-top-medium">
                            <label style="margin-bottom: 0px;" for="">Price</label>
                            <input type="number" class="a-input-text" style="width:100%;" name="" id="" v-model="price" :placeholder="product.price">
                        </div>

                        <div class="a-spacing-top-medium">
                            <label style="margin-bottom: 0px;" for="">Stock quantity</label>
                            <input type="number" class="a-input-text" style="width:100%;" name="" id="" v-model="stockQuantity" :placeholder="product.stockQuantity">
                        </div>
