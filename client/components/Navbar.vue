            ...
            <div class="container-fluid desktop-nav">
                ...
                <div class="row">
                        ...
                        <div class="nav-global-location">
                            <nuxt-link to="/address" class="nav-a nav-a-2">
                                ...
                                <div id="glow-ingress-block">
                                    <span class="nav-line-1" id="glow-ingress-line-1">Deliver to</span>
                                    <span class="nav-line-2" id="glow-ingress-line-2">{{ $auth.$state.user.address.state }}</span>
                                </div>
                            </nuxt-link>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                        <div class="nav-tools">
                            <a href="#" id="icp-nav-link-inner" class="nav-a nav-a-2 icp-link-style-2">
