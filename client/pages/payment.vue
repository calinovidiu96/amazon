...
export default {
    ...
    mounted(){
        this.stripe = Stripe('pk_test_51HPRd9GtYmaLllirl0nOTI0H40U5l2NdxRkDi2M1BqsIz9LLj90Rr33jZaPy4bsBw6TWKwWnm0D0OD4x3mD4dowP00zylIs8Dl');
    ...
    methods: {
        async onPurchase(){
            try {
                let token = this.stripe.createToken(this.card);
